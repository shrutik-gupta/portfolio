...
const Hero = () => {
    ...
    return (
        <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative mx-auto text-center bg-bg-secondary px-[10%] py-[3%] rounded-3xl mb-[5%] z-10 opacity-90"> {/* Added relative and z-10 for content to be above particles */}
                <div className="mb-8">
                    <img
                        src={profile}
                        alt="Profile"
